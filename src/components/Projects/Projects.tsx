		...
		<>
			...
			<div className={`container my-5`}>
				<div className="row">
					...
					<div
						className={`col-12 col-lg-6 ${styles.container}  pb-5`}>
						...
						<p className={styles.dsc_description}>
							...
							enthusiastic about growing developer communities and
							supports them with commencing student clubs on their
							campuses. Developer Student Clubs is a program that
							recognizes and supports university students who are
							excited about growing developer communities that
