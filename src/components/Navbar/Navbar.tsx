...
const Navbar = () => {
        ...
        <Toolbar className={styles.navToolbar} style={{margin : '0', height : '100%', position : 'relative'}}>
            <Box>
                ...
                <Drawer anchor='left' open={navState} onClose={() => navToggle(false)}>
                    <List>
                        <ListItem><Typography variant="h6" style={{fontWeight : '800'}}>DSC KIIT</Typography></ListItem>
 ...
 <img src="/dsc.svg" style={{marginRight : '10px', width : '1.5em'}}/>
                    DSC KIIT
                </Typography></Link>
            </Grid>
            <Grid item xs={7} container alignItems="center" spacing={3} justify="flex-end" className={styles.nav}>
                ...
                <Grid item>
                    <Link href="/projects"><Typography variant="body2" style={{cursor : 'pointer'}}>Projects</Typography></Link>
                </Grid>
                <Grid item>
