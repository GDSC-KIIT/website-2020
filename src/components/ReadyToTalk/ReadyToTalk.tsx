        ...
        <div className="container">
          ...
          <div className={styles.icon}>
            <div
              ...
              style={{ backgroundColor: "#3498db", marginLeft: -60 }}
            ></div>
            <div
              className={styles.bar}
              style={{ backgroundColor: "#e74c3c", marginLeft: -20 }}
            ></div>
            <div
              className={styles.bar}
              style={{ backgroundColor: "#f1c40f", marginLeft: 20 }}
            ></div>
            <div
              className={styles.bar}
              style={{ backgroundColor: "#27ae60", marginLeft: 60 }}
            ></div>
          </div>
